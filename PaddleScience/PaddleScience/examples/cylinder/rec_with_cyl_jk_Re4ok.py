...
if __name__ == "__main__":
    ...
    # PDE Laplace
    pdes = psci.pde.NavierStokes(nu=1e-2, rho=1, dim=2, time_dependent=True)
    ...
    # Optimizer
    opt = psci.optimizer.Adam(learning_rate=0.0001, parameters=net.parameters())

    # Solver
    solver = psci.solver.Solver(algo=algo, opt=opt)
    solution = solver.solve(num_epoch=15000)
